...
--NOTE-- This is an unofficial version
...
local function MurdererFinder()
   ...
   local Ent = v
   local Dist = math.floor(Ent:GetPos():Distance(me:GetShootPos())/40)
   draw.DrawText("Murderer Knife", "MiscFont", pos.x + w/50, pos.y + h /11, Color(255, 0, 0), 1)   --Changed from (100, 0, 255) to (255, 0, 0) as red is more visual for the murderer
   end
   ...
   local Ent = v
   local Dist = math.floor(Ent:GetPos():Distance(me:GetShootPos())/40)
   draw.DrawText("Magnum Pistol", "MiscFont", pos.x + w/50, pos.y + h /11, Color(0, 255, 0), 1)   --Changed from (100, 0, 255) to (0, 255, 0) as red is more visual for the bystander
   end
end
...
local function Visuals(v)
   ...
   local murderer_col = true && Color(255, 0, 0)
   local bystander_col = true && Color(0, 255, 0)
   ...
   if(gBool("Visuals", "Wallhack", "Box") && gOption("Visuals", "Wallhack", "Box Type:") == "2D Box") then
       ...
       -- if he is the bystander, his box will be green
        ...
        elseif (v:HasWeapon("weapon_mu_magnum")) then
           ...
           surface.DrawOutlinedRect(pos.x - w / 2 - 1, pos.y - h - 1, w + 2, h + 2)
           surface.DrawOutlinedRect(pos.x - w / 2 + 1, pos.y - h + 1, w - 2, h - 2)
        elseif (friendstatus == "friend") && !idiot.IsDev(v) then
